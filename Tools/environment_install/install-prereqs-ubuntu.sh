...
if [ ${RELEASE_CODENAME} == 'xenial' ] || [ ${RELEASE_CODENAME} == 'disco' ] || [ ${RELEASE_CODENAME} == 'eoan' ]; then
    ...
    PYTHON_PKGS="future lxml pymavlink-bir-k MAVProxy pexpect flake8==3.7.9 geocoder empy configparser==5.0.0 click==7.1.2 decorator==4.4.2"
else
    PYTHON_PKGS="future lxml pymavlink-bir-k MAVProxy pexpect flake8 geocoder empy"
fi
